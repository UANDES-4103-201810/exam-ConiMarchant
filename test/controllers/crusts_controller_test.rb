...
class CrustsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crust" do
    assert_difference('Crust.count') do
      post crusts_url, params: { crust: { typecrust: @crust.typecrust, value: @crust.value } }
    end
  ...
  test "should update crust" do
    patch crust_url(@crust), params: { crust: { typecrust: @crust.typecrust, value: @crust.value } }
